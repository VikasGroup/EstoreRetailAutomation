...
public class ShoppingcartPgObject {
	...
	public WebElement ryFoun_link = driver
			.findElement(By.xpath(".//*[@id='pnlRFDonation']/table/tbody/tr/td[1]/span/label/a"));
	...
	public String getProdName(int i) {
		...
		WebElement product = driver
				.findElement(By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_lblProdName"));
		return product.getText();
	}

	public String getRPP(int i) {
		i = i + 1;
		WebElement rppf = (driver.findElement(
				By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_ddlRepeatProduct")));
		return rppf.getText();
	}
	...
	public String getQTY(int i) {
		...
		WebElement qty = (driver
				.findElement(By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_tbQuantity")));
		return qty.getText();
	}
	...
	public String getPrice(int i) {
		...
		WebElement price = (driver
				.findElement(By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_lblPrice")));
		return price.getText();
	}

	public String getBV(int i) {
		i = i + 1;
		WebElement bv = (driver
				.findElement(By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_lblCUV")));
		return bv.getText();
	}

	public String getRSP(int i) {
		i = i + 1;
		WebElement rsp = (driver
				.findElement(By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_lblDSP")));
		return rsp.getText();
	}

	public void selectRPP(int i, String value) {
		i = i + 1;
		Select rppf = new Select(driver.findElement(
				By.id("dlProductCategoryContainer_ctl01_dgProductCategory_ctl0" + i + "_ddlRepeatProduct")));
